...
While `lru_cache` doesn't have a built-in time limit, what is the _concept_ you would use?
...
5.  **Benchmark**:
    ...
    - In a markdown file `benchmark.md`, report the time difference and explain _why_ your changes made the script faster, referencing the time complexities of the data structures and algorithms you used.
